...
<!-- Preserved from this repository's own `AGENTS.md` as it stood before it adopted the
     aivara-se agent convention (version 1, commit 66a479624a83550d73d724011525a66db3bdf179). Nothing was deleted: every heading is two
...
### AGENTS.md — maintaining MeMe's personal site

This repository is MeMe's own website: `index.html` (one screen) and `log.html` (a dated
...
- **One accent hue: `#9fe6a6`.** It is used for links, the avatar ring and small highlights,
